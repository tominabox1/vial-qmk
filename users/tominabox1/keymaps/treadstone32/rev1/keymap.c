...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
       KC_Z,     KC_X,  KC_C,      KC_V,     KC_B,  KC_K, KC_M,  KC_COMM,  KC_FDOT, KC_SLSH,
  //`---------+---------+---------+---------+---------+---------+---------+---------+---------+---------'
                                               KC_NAV_ENT,KC_NUM_SPC
  //                                        `---------|---------'
  ),
  ...
  [_NAV] = LAYOUT(
  //,---------------------------------------------------------------------------------------------------.
        KC_ESC,KC_MS_BTN1,KC_MS_UP,  KC_MS_BTN2,  KC_WH_U,  KC_GRV,KC_PGDN,    KC_UP,  KC_PGUP,    TD(TD_RESET),
  //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      RGB_TOG,KC_MS_LEFT,KC_MS_DOWN,KC_MS_RIGHT,KC_WH_D,KC_HOME, KC_LEFT,  KC_DOWN,  KC_RGHT,   KC_END,
  //|---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
       RGB_MOD,  RGB_HUD,  RGB_SAD,  RGB_VAD,  KC_NO,  KC_MINS,  KC_TRNS,  KC_COMM,   KC_DOT,  KC_BSLS,
  //`---------+---------+---------+---------+---------+---------+---------+---------+---------+---------'
                                               KC_MS_BTN1,  KC_TRNS
  //                                        `---------|---------'
  ),

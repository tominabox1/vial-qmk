...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    LT(_NAV, KC_Z), KC_X, KC_C, KC_V, KC_B, LCTL(KC_F12), KC_K, KC_M, KC_COMM, KC_DOT,
    DM_REC1, KC_MPLY, KC_NAV_ENT, KC_NUM_SPC, KC_MNXT,KC_SLSH
  ),

  [_NUM_SYM] = LAYOUT(
    KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0,
    KC_EXLM, KC_AT, KC_HASH, TD(TD_DLR_LP), KC_PERC, KC_CIRC, TD(TD_AMP_RP), KC_ASTR, KC_EQUAL, KC_MINS,
    DM_REC1, DM_RSTP, DM_PLY1,  KC_UNDS,  KC_UNDS,  LCTL(KC_F12), KC_RPRN,  KC_RBRC,  KC_COMM, KC_DOT,

...
int16_t max_ticks   = 28; // Windows - allows for full control from Mute to 100% volume on Windows systems when used as Vol Up/Down slider.
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(KC_A, KC_B, KC_C, KC_D, KC_E, KC_F, KC_G, KC_H),
    [2] = LAYOUT(KC_Z, KC_X, KC_Y, KC_W, KC_T, KC_S, KC_R, KC_Q)
};
